...
public class DamageSystem : MonoBehaviour
{
    ...
    // Calcula el vector de direcci�n reflejado a partir del vector de direcci�n de la colisi�n
    ...
    {
        // Calcular la direcci�n y la magnitud de la fuerza de la colisi�n
        Vector3 impulse = collision.impulse / Time.fixedDeltaTime;
        float magnitude = impulse.magnitude;

        // Aplicar la fuerza de la colisi�n al objeto utilizando el m�todo AddForce
